...
| Awesome WM                | `fl-awesome`           | `<i class="fl-awesome"></i>`           |  `0xf331`  | <img src="vectors/awesome.svg" width="24">           |
| BigLinux                  | `fl-biglinux`          | `<i class="fl-biglinux"></i>`          |  `0xf332`  | <img src="vectors/biglinux.svg" width="24">          |
| bspwm                     | `fl-bspwm`             | `<i class="fl-bspwm"></i>`             |  `0xf333`  | <img src="vectors/bspwm.svg" width="24">             |
...
| Cinnamon                  | `fl-cinnamon`          | `<i class="fl-cinnamon"></i>`          |  `0xf334`  | <img src="vectors/cinnamon.svg" width="24">          |
| Codeberg                  | `fl-codeberg`          | `<i class="fl-codeberg"></i>`          |  `0xf335`  | <img src="vectors/codeberg.svg" width="24">          |
| CoreOS                    | `fl-coreos`            | `<i class="fl-coreos"></i>`            |  `0xf305`  | <img src="vectors/coreos.svg" width="24">            |
| Crystal Linux             | `fl-crystal`           | `<i class="fl-crystal"></i>`           |  `0xf336`  | <img src="vectors/crystal.svg" width="24">           |
...
| dwm                       | `fl-dwm`               | `<i class="fl-dwm"></i>`               |  `0xf337`  | <img src="vectors/dwm.svg" width="24">               |
...
| Enlightenment             | `fl-enlightenment`     | `<i class="fl-enlightenment"></i>`     |  `0xf338`  | <img src="vectors/enlightenment.svg" width="24">     |
...
| Fluxbox                   | `fl-fluxbox`           | `<i class="fl-fluxbox"></i>`           |  `0xf339`  | <img src="vectors/fluxbox.svg" width="24">           |
| FreeBSD                   | `fl-freebsd`           | `<i class="fl-freebsd"></i>`           |  `0xf30c`  | <img src="vectors/freebsd.svg" width="24">           |
| Garuda Linux              | `fl-garuda`            | `<i class="fl-garuda"></i>`            |  `0xf33a`  | <img src="vectors/garuda.svg" width="24">            |
| Gentoo                    | `fl-gentoo`            | `<i class="fl-gentoo"></i>`            |  `0xf30d`  | <img src="vectors/gentoo.svg" width="24">            |
| GNOME                     | `fl-gnome`             | `<i class="fl-gnome"></i>`             |  `0xf33b`  | <img src="vectors/gnome.svg" width="24">             |
| GNU Guix                  | `fl-gnu-guix`          | `<i class="fl-gnu-guix"></i>`          |  `0xf325`  | <img src="vectors/gnu-guix.svg" width="24">          |
| Hyperbola GNU/Linux-libre | `fl-hyperbola`         | `<i class="fl-hyperbola"></i>`         |  `0xf33c`  | <img src="vectors/hyperbola.svg" width="24">         |
| Hyprland                  | `fl-hyprland`          | `<i class="fl-hyprland"></i>`          |  `0xf33d`  | <img src="vectors/hyprland.svg" width="24">          |
| i3                        | `fl-i3`                | `<i class="fl-i3"></i>`                |  `0xf33e`  | <img src="vectors/i3.svg" width="24">                |
| illumos                   | `fl-illumos`           | `<i class="fl-illumos"></i>`           |  `0xf326`  | <img src="vectors/illumos.svg" width="24">           |
| JWM                       | `fl-jwm`               | `<i class="fl-jwm"></i>`               |  `0xf33f`  | <img src="vectors/jwm.svg" width="24">               |
| Kali Linux                | `fl-kali-linux`        | `<i class="fl-kali-linux"></i>`        |  `0xf327`  | <img src="vectors/kali-linux.svg" width="24">        |
| KDE neon                  | `fl-kde-neon`          | `<i class="fl-kde-neon"></i>`          |  `0xf340`  | <img src="vectors/kde-neon.svg" width="24">          |
| KDE Plasma                | `fl-kde-plasma`        | `<i class="fl-kde-plasma"></i>`        |  `0xf341`  | <img src="vectors/kde-plasma.svg" width="24">        |
| Kubuntu                   | `fl-kubuntu`           | `<i class="fl-kubuntu"></i>`           |  `0xf342`  | <img src="vectors/kubuntu.svg" width="24">           |
...
| LXDE                      | `fl-lxde`              | `<i class="fl-lxde"></i>`              |  `0xf343`  | <img src="vectors/lxde.svg" width="24">              |
| LXLE Linux                | `fl-lxle`              | `<i class="fl-lxle"></i>`              |  `0xf344`  | <img src="vectors/lxle.svg" width="24">              |
| LXQt                      | `fl-lxqt`              | `<i class="fl-lxqt"></i>`              |  `0xf345`  | <img src="vectors/lxqt.svg" width="24">              |
...
| MATE                      | `fl-mate`              | `<i class="fl-mate"></i>`              |  `0xf346`  | <img src="vectors/mate.svg" width="24">              |
| MX Linux                  | `fl-mxlinux`           | `<i class="fl-mxlinux"></i>`           |  `0xf347`  | <img src="vectors/mxlinux.svg" width="24">           |
| Neovim                    | `fl-neovim`            | `<i class="fl-neovim"></i>`            |  `0xf348`  | <img src="vectors/neovim.svg" width="24">            |
...
| Parabola GNU/Linux-libre  | `fl-parabola`          | `<i class="fl-parabola"></i>`          |  `0xf349`  | <img src="vectors/parabola.svg" width="24">          |
...
| Puppy Linux               | `fl-puppy`             | `<i class="fl-puppy"></i>`             |  `0xf34a`  | <img src="vectors/puppy.svg" width="24">             |
| Qtile                     | `fl-qtile`             | `<i class="fl-qtile"></i>`             |  `0xf34b`  | <img src="vectors/qtile.svg" width="24">             |
...
| Sway                      | `fl-sway`              | `<i class="fl-sway"></i>`              |  `0xf34c`  | <img src="vectors/sway.svg" width="24">              |
| Trisquel GNU/Linux        | `fl-trisquel`          | `<i class="fl-trisquel"></i>`          |  `0xf34d`  | <img src="vectors/trisquel.svg" width="24">          |
...
| Vanilla OS                | `fl-vanilla`           | `<i class="fl-vanilla"></i>`           |  `0xf34e`  | <img src="vectors/vanilla.svg" width="24">           |
| Void                      | `fl-void`              | `<i class="fl-void"></i>`              |  `0xf32e`  | <img src="vectors/void.svg" width="24">              |
| Wayland                   | `fl-wayland`           | `<i class="fl-wayland"></i>`           |  `0xf34f`  | <img src="vectors/wayland.svg" width="24">           |
| XFCE                      | `fl-xfce`              | `<i class="fl-xfce"></i>`              |  `0xf350`  | <img src="vectors/xfce.svg" width="24">              |
| XMonad                    | `fl-xmonad`            | `<i class="fl-xmonad"></i>`            |  `0xf351`  | <img src="vectors/xmonad.svg" width="24">            |
| Xorg                      | `fl-xorg`              | `<i class="fl-xorg"></i>`              |  `0xf352`  | <img src="vectors/xorg.svg" width="24">              |
